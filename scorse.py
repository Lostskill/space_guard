...
class Scores():
    ...
    def image_score(self):
        self.score_img  = self.font.render(str(self.stats.score),True , self.color, (0,0,0))
        self.score_rect = self.score_img.get_rect()
        self.score_rect.right = self.screen_rect.right - 40
        self.score_rect.top = 20

    def image_high_score(self):
        self.high_score_image = self.font.render(str(self.stats.high_score), True, self.color, (0,0,0))
    ...
    def image_guns(self):
        self.guns = Group()
        for gun_number in range(self.stats.gunsleft):
            gun = Gun(self.screen)
